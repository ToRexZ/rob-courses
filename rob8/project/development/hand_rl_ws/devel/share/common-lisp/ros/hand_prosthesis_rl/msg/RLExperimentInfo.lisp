...
(cl:in-package hand_prosthesis_rl-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <RLExperimentInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RLExperimentInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hand_prosthesis_rl-msg:<RLExperimentInfo> is deprecated: use hand_prosthesis_rl-msg:RLExperimentInfo instead.")))

(cl:ensure-generic-function 'episode_number-val :lambda-list '(m))
(cl:defmethod episode_number-val ((m <RLExperimentInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hand_prosthesis_rl-msg:episode_number-val is deprecated.  Use hand_prosthesis_rl-msg:episode_number instead.")
  (episode_number m))

(cl:ensure-generic-function 'episode_reward-val :lambda-list '(m))
(cl:defmethod episode_reward-val ((m <RLExperimentInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hand_prosthesis_rl-msg:episode_reward-val is deprecated.  Use hand_prosthesis_rl-msg:episode_reward instead.")
  (episode_reward m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RLExperimentInfo>)))
  ...
  "hand_prosthesis_rl/RLExperimentInfo")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RLExperimentInfo)))
  "Returns string type for a message object of type 'RLExperimentInfo"
  "hand_prosthesis_rl/RLExperimentInfo")
