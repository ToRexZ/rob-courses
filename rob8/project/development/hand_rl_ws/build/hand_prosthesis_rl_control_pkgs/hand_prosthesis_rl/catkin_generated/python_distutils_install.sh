...
echo_and_run cd "/development/hand_rl_ws/src/hand_prosthesis_rl_control_pkgs/hand_prosthesis_rl"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/development/hand_rl_ws/src/hand_prosthesis_rl_control_pkgs/hand_prosthesis_rl/setup.py" \
     \
    build --build-base "/development/hand_rl_ws/build/hand_prosthesis_rl_control_pkgs/hand_prosthesis_rl" \
    install \
    --root="${DESTDIR-/}" \
